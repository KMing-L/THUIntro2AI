...
def preprocess(ziyuan, force):
    ...
    for month in SINA_MONTH:
        t = threading.Thread(target=count_month, args=(month, ziyuan))
        t.start()
...
if __name__ == '__main__':
    ...
    preprocess(args.ziyuan, args.force)
